...
(function initSearchToggle() {
  var btnOpen = document.querySelector('.header__open-search');
  var btnClose = document.querySelector('.head-search__btn--close');
  var block = document.querySelector('.head-search');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-fancybox]').fancybox({// beforeClose: function() {
